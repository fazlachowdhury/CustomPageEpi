...
namespace EPICodingChallenge.Models.Properties
{
    ...
    /// </summary>
    /// <remarks>For an example, see <see cref="EPICodingChallenge.Models.Pages.SitePageData"/> where this property type is used for the MetaKeywords property</remarks>
